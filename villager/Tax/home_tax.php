...
<head>
    ...
    <title>कर माहिती पहा</title>
    <style>
   :root {
    --primary-color: #FF7043; /* Warm Orange */
    --primary-dark: #E64A19; /* Darker Orange */
    --secondary-color: #FFF3E0; /* Light Cream */
    --border-color: #FFCCBC; /* Light Orange Border */
    --text-color: #333;
    --error-color: #f44336;
...
<body>
    <div class="wrapper">
        ...
        <div class="container">
        <h2 id="searchTitle">घरपट्टी शोध</h2>
        ...
        function displayResults(data) {
            ...
            data.records.forEach(record => {
                ...
                row.innerHTML = `
                    ...
                    <td>₹${parseFloat(record.previous_home_tax).toFixed(2)}</td>
                    <td>₹${parseFloat(record.current_home_tax).toFixed(2)}</td>
                    <td>₹${parseFloat(record.total_home_tax).toFixed(2)}</td>
                `;
