...
<head>
    ...
    <title>पाणी कर माहिती पहा</title>
    <style>
   :root {
...
<body>
    <div class="wrapper">
        ...
        <div class="container">
            <h2 id="searchTitle">पाणी कर शोधा</h2>
    ...
    <script>
        ...
        function displayResults(data) {
            ...
            data.records.forEach(record => {
                ...
                row.innerHTML = `
                    ...
                    <td>₹${parseFloat(record.previous_water_tax).toFixed(2)}</td>
                    <td>₹${parseFloat(record.water_tax).toFixed(2)}</td>
                    <td>₹${parseFloat(record.total_water_tax).toFixed(2)}</td>
                `;
        ...
        en: {
            ...
            searchTitle: "Search Water Tax Records",
