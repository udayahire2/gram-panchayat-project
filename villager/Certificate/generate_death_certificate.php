...
// Fetch the record from death_certificate table (not approved_death_certificate)
// This is because the button is on the page showing records from death_certificate with status 'APPROVED'
$sql = "SELECT * FROM death_certificate WHERE id = ? AND status = 'APPROVED'";
...
if (!$record) {
    die("Record not found or not approved");
}
        ...
        <div class="container">
            ...
            <div class="certificate-section" id="certificateSection">
                <div class="certificate" id="certificate">
                    ...
                    <div class="serial-number">Certificate Number: <?php echo htmlspecialchars($record['certificate_number']); ?></div>
                    ...
                    <div class="certificate-content">
                        ...
                        <div class="details-grid">
                            <div class="detail-row">
                                ...
                                <span class="value"><?php echo htmlspecialchars($record['name_of_deceased']); ?></span>
                            </div>
                            <div class="detail-row">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="value"><?php echo htmlspecialchars($record['age']); ?> years</span>
                            </div>
                            <div class="detail-row">
                                <span class="label">Aadhaar Number:</span>
                                <span class="value"><?php echo htmlspecialchars($record['aadhaar_number']); ?></span>
                            </div>
                            <div class="detail-row">
                                <span class="label">Date of Death:</span>
                                <span class="value"><?php echo date('d-m-Y', strtotime($record['date_of_death'])); ?></span>
                            </div>
                            <div class="detail-row">
                                <span class="label">Place of Death:</span>
                                <span class="value"><?php echo htmlspecialchars($record['place_of_death']); ?></span>
                            </div>
                            <div class="detail-row">
                        ...
                        <div class="certificate-footer">
                            <div class="qr-code">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=<?php 
                                    $qrData = "Certificate No: " . $record['certificate_number'] . "\n" .
                                             "Name: " . $record['name_of_deceased'] . "\n" .
                                             "Date of Death: " . date('d-m-Y', strtotime($record['date_of_death']));
