...
$sql = "SELECT * FROM approved_marriage_certificates ORDER BY created_at DESC";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="view_approved_death_certificates.php">View Approved Death Records</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="view_approved_marriage_certificates.php">View Approved Marriage Records</a>
                    </li>
                </ul>
                <div class="d-flex">
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>{$row['groom_age']}</td>
                                    <td>{$row['groom_address']}</td>
                                    <td>{$row['bride_name']}</td>
                                    <td>{$row['bride_age']}</td>
                                    <td>{$row['bride_address']}</td>
