...
$sql = "SELECT * FROM approved_death_certificates ORDER BY created_at DESC";
...
<head>
    ...
    <!-- Same CSS styles as view_approved_birth_certificates.php -->
    <style>
       * {
    margin: 0;
    padding: 0;
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="view_approved_death_certificates.php">View Approved Death Records</a>
                    </li>
                </ul>
                <div class="d-flex">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo '<tr><td colspan="9" style="text-align: center;">No approved records found</td></tr>';
                    }
                    ?>
                </tbody>
            </table>
    ...
    <script>
        function generateCertificate(id) {
            window.open('death_certificate_template.php?id=' + id, '_blank');
        }

        function generateRegistrationNumber(id) {
            // Add AJAX call to generate registration number if needed
            // This is a placeholder for the registration number generation functionality
            alert('Registration number generation functionality to be implemented');
        }
    </script>
</body>
</html>
